    ...
    <div className="legend__scrim" onClick={close}>
      <aside className="about" dir="rtl" role="dialog" aria-label="המודל" onClick={(e) => e.stopPropagation()}>
        ...
        <p className="about__lede">
          מאקרופוליטיקה מתייחסת אל המזרח התיכון כאל מערכת כבידה: לכל גוף משקל,
        ...
        <div className="about__cols">
          <div className="about__col">
            <h3>הכוחות</h3>
            <p>כבידתו של כל גוף — שקלול של כוח כלכלי, צבאי וגאו-אסטרטגי, בסולם 0–10. הכבידה קובעת את גודלו במפה.</p>
          </div>
          <div className="about__col">
            <h3>היחסים</h3>
