      ...
      <aside ref={dialogRef} className="about" dir="rtl" role="dialog" aria-modal="true" aria-label="המודל" inert={closing} onClick={(e) => e.stopPropagation()}>
        ...
        <div className="about__cols">
          <div className="about__col">
            ...
            <h3>הכוחות</h3>
            <p><Words delay={0.60} text="כוח המשיכה של כל גוף — שקלול של כוח כלכלי, צבאי וגאו-אסטרטגי, בסולם 0–10 — קובע את גודלו במפה." /></p>
          </div>
          <div className="about__col">
            <span className="about__col-n">02</span>
            <h3>היחסים</h3>
            <p><Words delay={1.05} text="כל יחס נמתח בין שלושה קטבים — מתח, חיכוך והרמוניה — ומיקומו במשולש מגדיר את אופיו מול מדינת הייחוס." /></p>
          </div>
          <div className="about__col">
            <span className="about__col-n">03</span>
            <h3>יחסי הכוחות</h3>
            <p><Words delay={1.50} text="התמונה המלאה: גופים במסלולים סביב מרכזי כובד. המרחק, הטבעת והמסלול מבטאים תלות, חסות וזיקה." /></p>
          </div>
        </div>
